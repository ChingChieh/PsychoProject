...
"")
        ...
        self.src_4 = QtWidgets.QLabel(self.top)
        font = QtGui.QFont()
        font.setPointSize(40)
        font.setBold(True)
        font.setWeight(75)
        self.src_4.setFont(font)
        self.src_4.setStyleSheet("color : red;")
        self.src_4.setAlignment(QtCore.Qt.AlignCenter)
        self.src_4.setObjectName("src_4")
        self.horizontalLayout_7.addWidget(self.src_4)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_7.addItem(spacerItem1)
        self.src_6 = QtWidgets.QLabel(self.top)
        font = QtGui.QFont()
        font.setPointSize(40)
        font.setBold(True)
        font.setWeight(75)
        self.src_6.setFont(font)
        self.src_6.setStyleSheet("color : red;")
        self.src_6.setAlignment(QtCore.Qt.AlignCenter)
        self.src_6.setObjectName("src_6")
        self.horizontalLayout_7.addWidget(self.src_6)
        spacerItem2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_7.addItem(spacerItem2)
        self.src_5 = QtWidgets.QLabel(self.top)
        font = QtGui.QFont()
        font.setPointSize(40)
        font.setBold(True)
        font.setWeight(75)
        self.src_5.setFont(font)
        self.src_5.setStyleSheet("color : red;")
        self.src_5.setAlignment(QtCore.Qt.AlignCenter)
        self.src_5.setObjectName("src_5")
        self.horizontalLayout_7.addWidget(self.src_5)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.src_4.setText(_translate("MainWindow", "0"))
        self.src_6.setText(_translate("MainWindow", "0"))
        self.src_5.setText(_translate("MainWindow", "0"))
